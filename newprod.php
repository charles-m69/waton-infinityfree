    ...
    <?php
        ...
        if(isset($_POST['prod_created'])) {
            ...
            if(move_uploaded_file($_FILES["prod_photo"]["tmp_name"], $target_file_path)) {
                ...
                $insert_sql = "INSERT INTO `tbl_waton_product`(`prod_photo`, `prod_name`, `prod_desc`, `prod_price`, `prod_stock`, `prod_by`, `user_id`, `category_id`) VALUES ('$prod_photo','$prod_name','$prod_desc','$prod_price','$prod_stock', '$prod_by', '$user_id', '$category_id')";
