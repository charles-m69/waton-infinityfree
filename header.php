<?php
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        $sql = "SELECT * FROM `tbl_waton_user` WHERE `user_id` = '$user_id'";
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="<?=BASE_URL.$user['user_photo'];?>" class="img-fluid rounded-circle" style="width: 30px; height: 30px; object-fit: cover; margin-right: 5px;">
                                <?=$user['username'];?>
                            </a>
