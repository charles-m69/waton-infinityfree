    ...
    if(isset($_SESSION['user_id']) &&  isset($_SESSION['username'])) {
        ...
        if(isset($_POST['user_password']) && isset($_POST['user_new_password']) && isset($_POST['user_retype_password'])){
            ...
            if(empty($user_new_password)) {
                Header("Location: ../resetpassword.php?error=" . urlencode("Please type your new password"));
                exit();
            } else if($user_new_password !== $user_retype_password) {
                Header("Location: ../resetpassword.php?error=" . urlencode("Password does not match"));
                exit();
            } else {
                ...
                if(mysqli_num_rows($result) === 1) {
                    ...
                    Header("Location: ../resetpassword.php?error=" . urlencode("Incorrect password"));
                    exit();
                }
            }
